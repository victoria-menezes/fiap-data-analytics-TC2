...
# Sobre o repositório
`notebook_Classifier` e `notebook_TS` ambos mostram desenvolvimento de diversos modelos, um de modelos classificadores e outro de modelos time series. O modelo final está no `notebook_Classifier`, com o outro notebook permanecendo aqui para expor o processo inteiro.